...
const mockUser: ChatUser[] = [
  { id: '1', email: 'user1@exam.com', nickname: '김철수', avatar_url: null },
  { id: '2', email: 'user2@exam.com', nickname: '고길동', avatar_url: null },
  { id: '3', email: 'user3@exam.com', nickname: '이영희', avatar_url: null },
  { id: '4', email: 'user4@exam.com', nickname: '정수진', avatar_url: null },
];
/**
 * Mock 채팅방 목록 데이터
...
const mockChats: ChatListItem[] = [
  {
    id: 'chat1',
    name: '김철수', // 채팅방 이름인데 1:1 이라서 상대방 닉네임으로 출력
    type: 'direct',
    last_message: {
      // 마지막 메시지 정보(선택사항)
      content: '안녕하세요!', // 내용
  ...
  {
    id: 'chat2',
    name: '이영희', // 채팅방 이름인데 1:1 이라서 상대방 닉네임으로 출력
    type: 'direct',
    last_message: {
      // 마지막 메시지 정보(선택사항)
 ...
 *  채팅방 ID를 키 로 해서 각 채팅방의 메시지를 그룹화 후 관리
 */
