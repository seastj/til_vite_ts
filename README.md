...
- Supabase 에는 이메일 인증을 테스트만 제공한다. (1시간에 3번만 사용가능)
...
- Redirect URLs : `http://localhost:5173`, `http://localhost:3000`
...
- AuthContext.tsx 에 loading 이라는 처리를 진행해 주고 활용함.
